...
document.addEventListener('DOMContentLoaded', () => {
	...
	Dom.displayLendingsBorrower(world.findLendingsIBorrow(friendname, username, Dom.displayLendingsBorrower, Dom.errorRetrievingBorrows))
	Dom.displayLendingsLoaner(world.findLendingsILoan(friendname, username, Dom.displayLendingsLoaner, Dom.errorRetrievingLendings))
